    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('IDEA', 'Idée'), ('CONCEPT', 'Concept'), ('SOLUTION', 'Solution'), ('QUESTION', 'Question'), ('CHALLENGE', 'Challenge communautaire')], max_length=20)),
                ('domain', models.CharField(choices=[('TECH', 'Technologie'), ('ECO', 'Écologie'), ('HEALTH', 'Santé'), ('BUSINESS', 'Business'), ('CULTURE', 'Culture')], max_length=20)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
